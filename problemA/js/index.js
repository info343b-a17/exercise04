...
//Replace the word "iSchool" in the motto with the words "Information School".
//This new value should _replace_ the `motto` variable's value
...
//Create an array `numbers` that contains the first 10 decimals of Pi
