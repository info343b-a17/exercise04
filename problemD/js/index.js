...
/* Below is an array of objects representing Husky Football games from the 2016
   season. Each object has the same properties, making it into a data table. */
let huskyGames2016 = [
...
//You can test this by padding in an individual element from the array.



//Use the `map()` method and your `extractOpponent()` function to create an array
//of UW's opponents for the season.
...
//Your function should handle the case where the _first_ game is an empty
//object, in which case it should return the second game.
...
//Log out the array of games lost at home.
